...
generic graph toolkit. It is a production-grade drop-in layer for structured
...
with a canvas with spatial layout, synchronized outline panel, rich-text nodes,
...
Early public release. The TypeScript core and React adapter are available under
the MIT license. Vue and Svelte adapters are planned.

Live demo: https://mapdemo.tripleadigital.io/
